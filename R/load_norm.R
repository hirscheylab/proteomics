...
# proteins_raw A raw data frame with protein abundances
# peptides_raw A raw data frame with peptide abundances
# num_input Number of input kits in the experiment
# num_group Number of experimental plexes
# num_exp Number of experimental subgroups per plex
# num_pool Number of num_pool groups
# norm_coefs return the load normalization coefficients
