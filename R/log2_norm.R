# data The dataframe that you want to normalize, with all of the samples you want to normalize in the last columns
# num_sample The number of samples in your dataframe that your are normalizing
